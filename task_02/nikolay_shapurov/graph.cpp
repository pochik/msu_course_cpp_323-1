...
public:
  ...
  Graph(int num_v, int num_e) {
    ...
    assert((num_v >= 0) && "Invalid number of vertices. Must be positive integer.");
    assert((num_e >= 0) && "Invalid number of edges. Must be positive integer.");
  ...
  void add_edge(int edge_id, int vertex_id1, int vertex_id2){
      ...
      assert((vertex_id1 >= 0) && "Invalid the first vertex ID. Must be positive integer.");
      assert((vertex_id2 >= 0) && "Invalid the second vertex ID. Must be positive integer.");
